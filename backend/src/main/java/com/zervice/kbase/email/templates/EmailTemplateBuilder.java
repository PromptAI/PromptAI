...
import com.zervice.kbase.email.templates.preset.TableFourColumnPreset;
import com.zervice.kbase.email.templates.preset.TableSimplePreset;
import com.zervice.kbase.email.templates.preset.TableSimpleWithImagePreset;
...
public final class EmailTemplateBuilder {
    ...
    public static class EmailTemplateConfigBuilder {
        ...
        @Getter
        private TbConfiguration _configuration = TbConfiguration.newInstance();
        ...
        public HtmlTextEmail build() {
            return EmailTemplateBuilder.build(_configuration, header, contentLines, footerLines);
        }
