import { dashboardMessagesFallback } from '@/api/dashboard';
...
const MessagesFallback = () => {
  ...
  const { loading, data } = useRequest(
    () => dashboardMessagesFallback(buildParams(time, { projectId: id })),
    {
      refreshDeps: [time, id],
    }
  );
      ...
      title={
        <Space>
          <Typography.Text type="secondary">
            {t['dashboard.message.total.fallback']}
          </Typography.Text>
        </Space>
      }
      extra={
