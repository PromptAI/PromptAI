...
const LinkShare = ({ share, onChange }: LinkShareProps) => {
  ...
  return (
    <div>
      ...
      >
        {t['conversation.botForm.linkShare']}
      </Button>
      <Modal
        title={t['conversation.botForm.linkShare.title']}
        visible={visible}
      ...
      >
        <Form form={form} initialValues={share} layout="vertical">
          <Form.Item
            label={t['conversation.botForm.linkShare.form.name']}
            field="id"
            rules={rules}
          >
            <Select
              loading={loading}
              placeholder={
                t['conversation.botForm.linkShare.form.name.placeholder']
              }
              showSearch
              allowClear
