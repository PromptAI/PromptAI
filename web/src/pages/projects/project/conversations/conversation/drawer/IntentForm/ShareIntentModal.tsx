  ...
  return (
    <div>
      <Button
        ...
        onClick={openModal}
      >
        {t['conversation.intentForm.shareLink']}
      </Button>
      <Modal
        title={t['conversation.intentForm.shareLink.title']}
        visible={visible}
      ...
      >
        <Form ref={formRef} initialValues={share} layout="vertical">
          <Form.Item
            label={t['conversation.intentForm.shareLink.form.name']}
            field="name"
            rules={rules}
            labelCol={{ span: 6 }}
            wrapperCol={{ span: 18 }}
          >
            <Input
              autoFocus
              placeholder={
                t['conversation.intentForm.shareLink.form.name.placeholder']
              }
            />
          </Form.Item>
        </Form>
...
export default ShareIntentModal;
